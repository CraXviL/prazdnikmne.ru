<template>
	<section>
		<ul>
			<img id="photoGallery" v-for="(item, i) in photoGallerySize" :key="i" :src="srcPhotoSmall + i + '.jpg'" @click="index = 0">
		</ul>
		<ul v-if="videoGallerySize !== undefined" @click="index = photoGallerySize">
			<img id="videoGallery" :src="srcVideoSmall + '0.jpg'">
			<img id="play" src="img/main/video-play.png" alt="play">
		</ul>
